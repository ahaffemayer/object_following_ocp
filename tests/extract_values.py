...
def main():
    ...
    print(
        f'assert loader.object_info.mesh_id == "{loader.object_info.mesh_id}"')
    print(
    ...
    if len(loader.poses) > 0:
        ...
        print(
            f"np.testing.assert_array_almost_equal(loader.poses[0].t, expected_t_0)")
        print(
            f"assert loader.poses[0].score == pytest.approx({loader.poses[0].score})")
        print(f"assert loader.poses[0].im_id == {loader.poses[0].im_id}")
        print(
            f"assert loader.poses[0].object_id == {loader.poses[0].object_id}")
        print()
        ...
        print(
            f"expected_R_0_row0 = np.array([{R[0, 0]}, {R[0, 1]}, {R[0, 2]}])")
        print(
    ...
    if len(loader.grasp_poses) > 0:
        ...
        print(f"np.testing.assert_array_almost_equal(loader.best_grasp.position, expected_grasp_pos)")
        print()
        ...
        print(f"np.testing.assert_array_almost_equal(loader.best_grasp.orientation, expected_grasp_ori)")
        print()
    ...
    print(f"np.testing.assert_array_almost_equal(best_se3.translation, expected_grasp_pos)")
    print()
