...
def list_to_se3(poses):
    ...
    for p in poses:
        ...
        se3_list.append(pin.SE3(R, t) * rot)
    return se3_list


# rot = pin.SE3(pin.utils.rpyToMatrix(0, 0, 0), np.array([0.00, 0.0, 0.05]))
rot = pin.SE3(pin.utils.rpyToMatrix(0, 0, 90), np.array([0, -0.05, 0.0]))
...
q0 = np.array([-4.09307642, 0.40309675, -1.12163314, -1.61681233, 0.41038914,  0.72361027,
               -1.51009607])
