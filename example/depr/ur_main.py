...
from object_following_ocp.robot.robot_loader import load_kinova
...
if __name__ == "__main__":
    ...
    rmodel, cmodel, vmodel = load_kinova()
    ...
    # gripper_objects = make_gripper_objects(scene)
    # rmodel2, cmodel2, vmodel2 = load_ur5_pin()

    # robot2 = Robot(
    # pinocchio_model=rmodel2,
    # pinocchio_data=rmodel2.createData(),
    # pinocchio_geometry_model=vmodel2,
    # pinocchio_geometry_data=vmodel2.createData(),
    # )
    # scene.add_robot(robot=robot2)
    ...
    wMcamera.translation = np.array([-0.0, -0.5, -1.0])
    ...
    if solution is not None:
        ...
        tcp_frame_id = rmodel.getFrameId("tool_frame")
        wM_tcp_pinocchio = rdata.oMf[tcp_frame_id]

        print("\n" + "=" * 60)
        print("Pinocchio FK (tool_frame frame):")
        print("=" * 60)
